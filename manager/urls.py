...
urlpatterns = [
    ...
    path('data/user-data/students/<slug:username>/edit/',studentedit,name="m_student_edit"),
    path('data/user-data/teachers/<slug:username>/edit/',teacheredit,name="m_teacher_edit"),
